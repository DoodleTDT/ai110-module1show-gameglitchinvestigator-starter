...
from logic_utils import parse_guess, check_guess, update_score, get_range_for_difficulty
...
# FIX: Refactored the attempts initialization to equal 0 if the game just started
...
if submit:
    ...
    if not ok:
        ...
        #FIX: Refactored to get rid of string answers
